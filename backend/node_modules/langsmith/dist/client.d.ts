...
export declare function _checkBackendVersion(backendVersion: string, minVersion: string): void;
...
export declare class Client implements LangSmithTracingClientInterface {
    ...
    private _stainlessVersionsChecked;
    ...
    /** @deprecated Pass all params within an object and populate sessionId. */
    createFeedback(runId: string | null, key: string, options: CreateFeedbackLegacyOptions): Promise<Feedback>;
    ...
    _logEvaluationFeedback(evaluatorResponse: EvaluationResult | EvaluationResult[] | EvaluationResults, run?: Run, sourceInfo?: {
        [key: string]: any;
    }, sessionId?: string): Promise<[results: EvaluationResult[], feedbacks: Feedback[]]>;
    ...
    logEvaluationFeedback(evaluatorResponse: EvaluationResult | EvaluationResult[] | EvaluationResults, run?: Run, sourceInfo?: {
        [key: string]: any;
    }, sessionId?: string): Promise<EvaluationResult[]>;
    /**
