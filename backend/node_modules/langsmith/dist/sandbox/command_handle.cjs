...
class CommandHandle {
    ...
    async _ensureStarted() {
        ...
        if (firstResult.done) {
            throw new errors_js_1.LangSmithStreamEndedBeforeStartedError("Command stream ended before 'started' message");
        }
    ...
    async *[Symbol.asyncIterator]() {
        ...
        while (true) {
            try {
                ...
                if (!(e instanceof errors_js_1.LangSmithSandboxConnectionError)) {
                    throw e;
                }
                ...
                const isHotReload = e instanceof errors_js_1.LangSmithSandboxServerReloadError;
                if (!isHotReload) {
