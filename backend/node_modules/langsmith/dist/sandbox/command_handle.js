 ...
 */
import { LangSmithSandboxConnectionError, LangSmithSandboxServerReloadError, LangSmithSandboxOperationError, LangSmithStreamEndedBeforeStartedError, } from "./errors.js";
/**
...
export class CommandHandle {
    ...
    async _ensureStarted() {
        ...
        if (firstResult.done) {
            throw new LangSmithStreamEndedBeforeStartedError("Command stream ended before 'started' message");
        }
