...
export declare const WS_OPEN_TIMEOUT: number | undefined;
export declare const WS_CONNECT_BUDGET: number | undefined;
/** Instant after which connect attempts must stop, if bounded. */
export declare function connectDeadline(): number | undefined;
/** Seconds left in the connect budget, or undefined when unbounded. */
export declare function remainingBudget(deadline: number | undefined): number | undefined;
/** Per-attempt open timeout, clamped so it cannot outlive `deadline`. */
export declare function openTimeoutFor(deadline: number | undefined): number | undefined;
type WsWebSocket = any;
/** Whether the optional `ws` package could be loaded (resolved once). */
export declare function isWsAvailable(): Promise<boolean>;
/**
