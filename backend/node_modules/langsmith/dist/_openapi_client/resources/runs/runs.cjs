...
class Runs extends resource_js_1.APIResource {
    ...
    getURL(runID, query, options) {
        return this._client.get((0, path_js_1.path) `/api/v2/runs/${runID}/url`, { query, ...options });
    }
    /**
    ...
    queryV2(params, options) {
        ...
        return this._client.getAPIList('/api/v2/runs/query', (pagination_js_1.ItemsCursorPostPagination), {
            body,
            method: 'post',
            ...options,
    ...
    retrieveV2(runID, params, options) {
        ...
        return this._client.get((0, path_js_1.path) `/api/v2/runs/${runID}`, {
            query,
            ...options,
            headers: (0, headers_js_1.buildHeaders)([{ ...(Accept != null ? { Accept: Accept } : undefined) }, options?.headers]),
        });
