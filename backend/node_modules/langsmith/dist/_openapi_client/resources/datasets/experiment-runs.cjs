...
class ExperimentRuns extends resource_js_1.APIResource {
    ...
    query(datasetID, body, options) {
        return this._client.getAPIList((0, path_js_1.path) `/api/v2/datasets/${datasetID}/experiment-runs`, (pagination_js_1.ItemsCursorPostPagination), { body, method: 'post', ...options });
    }
}
