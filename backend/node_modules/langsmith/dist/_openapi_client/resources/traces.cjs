...
class Traces extends resource_js_1.APIResource {
    ...
    listRuns(traceID, params, options) {
        ...
        return this._client.get((0, path_js_1.path) `/api/v2/traces/${traceID}/runs`, {
            query,
            ...options,
     ...
     */
    query(body, options) {
        return this._client.getAPIList('/api/v2/traces/query', (pagination_js_1.ItemsCursorPostPagination), {
            body,
            method: 'post',
            ...options,
        });
