...
export declare class Threads extends APIResource {
     ...
     * ```
     */
    listTraces(threadID: string, query: ThreadListTracesParams, options?: RequestOptions): PagePromise<ThreadTracesItemsCursorGetPagination, ThreadTrace>;
    /**
     ...
     * ```
     */
    query(body: ThreadQueryParams, options?: RequestOptions): PagePromise<ThreadsItemsCursorPostPagination, Thread>;
    /**
...
export interface Thread {
     ...
     */
    feedback_stats?: {
        [key: string]: Thread.FeedbackStats;
    };
    /**
...
export interface ThreadStats {
     ...
     */
    feedback_stats?: {
        [key: string]: ThreadStats.FeedbackStats;
    };
    /**
...
export declare namespace ThreadStats {
    /**
     * `completion_cost_details` is the per-sub-category sum of completion cost details
     * across the thread. Populated when `COMPLETION_COST_DETAILS` is selected.
     */
...
export declare namespace ThreadTrace {
    /**
     * `completion_cost_details` is the USD cost breakdown for completion-side
     * categories; per-category values are under `raw`. Omitted unless included in
     * `selects`.
...
export declare namespace Threads {
    export { type Thread as Thread, type ThreadStats as ThreadStats, type ThreadTrace as ThreadTrace, type ThreadTracesItemsCursorGetPagination as ThreadTracesItemsCursorGetPagination, type ThreadsItemsCursorPostPagination as ThreadsItemsCursorPostPagination, type ThreadListTracesParams as ThreadListTracesParams, type ThreadQueryParams as ThreadQueryParams, type ThreadStatsParams as ThreadStatsParams, };
}
