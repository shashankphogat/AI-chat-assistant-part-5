...
class Threads extends resource_js_1.APIResource {
    ...
    listTraces(threadID, query, options) {
        return this._client.getAPIList((0, path_js_1.path) `/api/v2/threads/${threadID}/traces`, (pagination_js_1.ItemsCursorGetPagination), { query, ...options });
    }
    /**
     ...
     */
    query(body, options) {
        return this._client.getAPIList('/api/v2/threads/query', (pagination_js_1.ItemsCursorPostPagination), {
            body,
            method: 'post',
            ...options,
        });
    ...
    stats(threadID, query, options) {
        return this._client.get((0, path_js_1.path) `/api/v2/threads/${threadID}/stats`, { query, ...options });
    }
}
