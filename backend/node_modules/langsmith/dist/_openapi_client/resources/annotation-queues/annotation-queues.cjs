...
const ItemsAPI = __importStar(require("./items.cjs"));
const items_js_1 = require("./items.cjs");
...
class AnnotationQueues extends resource_js_1.APIResource {
    constructor() {
        ...
        Object.defineProperty(this, "items", {
            ...
            configurable: true,
            writable: true,
            value: new ItemsAPI.Items(this._client)
        });
    }
    /**
...
AnnotationQueues.Items = items_js_1.Items;
