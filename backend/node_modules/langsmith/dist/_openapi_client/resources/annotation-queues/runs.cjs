...
class Runs extends resource_js_1.APIResource {
    ...
    create(queueID, params, options) {
        ...
        return this._client.post((0, path_js_1.path) `/api/v1/annotation-queues/${queueID}/runs`, {
    ...
    createByKey(queueID, params, options) {
        const { body, extend_trace_retention } = params;
        return this._client.post((0, path_js_1.path) `/api/v1/annotation-queues/${queueID}/runs/by-key`, {
            query: { extend_trace_retention },
            body: body,
            ...options,
        });
